...
In questa sezione verifichiamo che un grafo generato tramite un opportuno
processo probabilistico è con alta probabilità un expander.
Ciò dimostrerà l'esistenza di expander, che fino a questo punto non è
scontata.
...
richiede un po' più di lavoro. Rimandiamo al Capitolo 21 di \cite{ABbook}.

Siamo pronti per descrivere un processo casuale che, con alta probabilità,
produce un expander.

% HERE
\lorenzo{TBD, vd Trevisan.}

Lo mostriamo per $n$ pari. Si prende $G$ unione di $d$ matching perfetti scelti
con distribuzione uniforme\footnote{Vedi \url{https://lucatrevisan.wordpress.com/2016/04/21/cs294-expansion-of-random-graphs/}.}.
