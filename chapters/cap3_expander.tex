...
\lorenzo{TBD. Definizione combinatoria ed equivalenza tra le due?}

Un grafo generato tramite un opportuno processo casuale è un expander con
buona probabilità. In particolare, quindi, esistono expander.
...
\lorenzo{TBD. Quello è proprio il valore atteso del numero di archi.}
...
\end{theorem}
\begin{proof}
	TBD. Anzi no, forse voglio saltarla.
\end{proof}
