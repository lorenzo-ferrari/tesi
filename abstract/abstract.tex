...
Se tuttavia ci venisse fornita la dimostrazione molto lunga di un teorema
...
complessità, a partire dalle classi $\P$ e $\NP$, rispettivamente la classe
...
ipotesi non si può approssimare efficientemente \texttt{3SAT} oltre una certa
soglia costante. Grazie al precedente lavoro di Papadimitriou e Yannakakis,
ciò sbloccò in un colpo solo risultati di inapprossimabilità per molti altri
problemi.
...
Ci interesseremo infine all'esistenza di expander e alla loro costruzione.
